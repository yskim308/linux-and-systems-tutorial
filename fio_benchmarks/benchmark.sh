...
iostat -xz 0.5 > results/raw/seq_write_async_iostat.log &
MON_PID=$!
...
iostat -xz 0.5 > results/raw/seq_read_sync_iostat.log &
MON_PID=$!
...
iostat -xz 0.5 > results/raw/rand_write_sync_iostat.log &
MON_PID=$!
...
iostat -xz 0.5 > results/raw/rand_read_sync_iostat.log &
MON_PID=$!
