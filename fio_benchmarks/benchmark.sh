...
iostat -xz 1 > results/raw/seq_write_sync_iostat.log &
MON_PID=$!
...
iostat -xz 1 > results/raw/seq_read_async_iostat.log &
MON_PID=$!
...
iostat -xz 1 > results/raw/rand_write_async_iostat.log &
MON_PID=$!
...
iostat -xz 1 > results/raw/rand_read_async_iostat.log &
MON_PID=$!
...
iostat -xz 1 > results/raw/seq_to_rand_iostat.log &
MON_PID=$!
